    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="container relative z-20 min-h-[90vh] flex flex-col justify-center">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block mb-6 px-4 py-1.5 rounded-full bg-lino-yellow/20 backdrop-blur-sm text-lino-yellow text-sm font-medium animate-fade-in">
          ...
          <p className="text-xl md:text-2xl mb-10 text-gray-300 animate-fade-in max-w-3xl mx-auto">
